...
function Cirugia() {
  ...
  if (showPrint) {
    return <RecetaPrint formData={formData} analiticas={analiticas} tipo="Cirugia" onClose={() => setShowPrint(false)} />;
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-blue-900">Pre Quirurgico</h1>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  <label className="block text-gray-700 font-medium mb-2">Diagnóstico</label>
                  <input
                    type="text"
                    name="diagnostico"
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">
                Analíticas indicadas para Paciente Post Cirugía
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  ...
                  { key: 'aso', label: 'ASO' },
                  { key: 'pcr', label: 'PCR' },
                  { key: 'eritrosedimentacion', label: 'Eritrosedimentación' },
                  ...
                  {key: 'tgp', label: 'TGP'},
                  {key: 'perfilLipidico', label: 'Perfil Lipidico'},
